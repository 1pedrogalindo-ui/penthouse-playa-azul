...
const penthouseLabels = [
  ...
  "Sala panorámica frente al Pacífico", "Área social al atardecer", "Ventanales de piso a techo", "Comedor y entretenimiento", "Área social de concepto abierto", "Salón amplio del dúplex", "Cocina totalmente equipada", "Horizonte desde el balcón", "Baño completo", "Terraza privada al atardecer", "Jacuzzi en la hora dorada", "Jacuzzi panorámico", "Terraza sobre el océano",
];
const englishLabels = [
  ...
  "Panoramic Pacific-facing lounge", "Sunset social area", "Floor-to-ceiling ocean windows", "Dining and entertainment area", "Open-plan social area", "Spacious duplex lounge", "Fully equipped kitchen", "Balcony horizon", "Full bathroom", "Private sunset terrace", "Golden-hour jacuzzi", "Panoramic jacuzzi", "Terrace above the ocean",
];
  ...
  return (
    <main>
      ...
      <section id="inicio" className="hero">
        <Image src="/images/penthouse-44.webp" alt="Jacuzzi privado del Penthouse Playa Azul frente al océano al atardecer" fill priority quality={95} sizes="100vw" className="hero-image" /><div className="hero-shade" />
      ...
      <section id="experiencia" className="story section-pad">
        ...
        <button className="story-photo large" onClick={() => openGallery("penthouse", 42, "experience_terrace")} aria-label="Abrir fotografía de la terraza"><Image src="/images/penthouse-43.webp" alt="Terraza privada con jacuzzi y puesta de sol sobre el océano" fill quality={94} sizes="(max-width: 800px) 100vw, 60vw" /><span><Expand/> {lang === "es" ? "Abrir vista" : "Open view"}</span></button>
      ...
      <section id="penthouse" className="inside section-pad">
        ...
        <div className="editorial-grid">
          <button className="editorial-photo tall" onClick={() => openGallery("penthouse", 32, "penthouse_lounge_view")}><Image src="/images/penthouse-33.webp" alt="Sala y comedor del penthouse con vista panorámica al océano" fill sizes="(max-width: 800px) 100vw, 45vw" /><span>{lang === "es" ? "Sala frente al Pacífico" : "Pacific-facing lounge"}</span></button>
          ...
          <button className="editorial-photo wide" onClick={() => openGallery("penthouse", 33, "penthouse_lounge")}><Image src="/images/penthouse-34.webp" alt="Área social del penthouse iluminada por el atardecer" fill sizes="(max-width: 800px) 100vw, 55vw" /><span>{lang === "es" ? "Área social al atardecer" : "Sunset social area"}</span></button>
        </div>
      </section>
